#ifndef DEVDUINO_THERMOMETER_SPRITE
#define DEVDUINO_THERMOMETER_SPRITE
...
const uint8_t ThermometerSprite::buffer[8][48] PROGMEM = {
	...
	ThermometerSprite thermometerSprite;
#endif //DEVDUINO_THERMOMETER_SPRITE